...
void MainWindow::setupConnections() {
    //KWADRAT WARTOSCI
    connect(ui->spinBox, QOverload<double>::of(&QDoubleSpinBox::valueChanged),
            this, &MainWindow::updateLabelSquare);
    ...
    connect(ui->calendarWidget, &QCalendarWidget::clicked, this, &MainWindow::syncCalendarWithDateEdit);
    ...
    connect(ui->spinBoxRed, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainWindow::updateColor);
    connect(ui->sliderGreen, &QSlider::valueChanged, this, &MainWindow::updateColor);
    connect(ui->spinBoxGreen, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainWindow::updateColor);
    connect(ui->sliderBlue, &QSlider::valueChanged, this, &MainWindow::updateColor);
    connect(ui->spinBoxBlue, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainWindow::updateColor);
}
